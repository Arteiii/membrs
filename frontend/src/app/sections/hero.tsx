            ...
            <section id="Hero"
                ...
                <div className="md:flex-1 md:mr-10">
                    ...
                    <p className="font-pt-serif font-normal mb-7">
                        membrs simplifies Discord community management by enabling seamless OAuth login for members, facilitating efficient backup and essential operations.
                    </p>
                    <div className="font-montserrat flex">
                        <a href="https://github.com/Arteiii/membrs" className="flex items-center">
                            <button className="flex bg-black px-6 py-4 rounded-lg border-2 border-black border-solid text-white mr-2 mb-2">
                                <GitHubLogoIcon height={24} width={24} className="mr-3"></GitHubLogoIcon>
                                Checkout GitHub
                            </button>
                        </a>
                        <div>
                            <button onClick={togglePopup} className="px-6 py-4 border-2 border-black border-solid rounded-lg">
                                Test Login
                            </button>
